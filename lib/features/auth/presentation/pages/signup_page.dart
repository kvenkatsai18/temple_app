...
class _SignUpPageState extends State<SignUpPage> {
  ...
  String _determineRoleFromEmail(String email) {
    ...
    // Super admin check (specific email)
    if (emailLower == 'superadmin@templeapp.com' || emailLower == 'superadmin@gmail.com') {
      return 'super_admin';
    }
    // Temple admin check (specific domain)
    if (emailLower.endsWith('@templeadmin.com') || emailLower.endsWith('@admin.temple')) {
      return 'temple_admin';
    }
